...
export const getAllUserSuccess = createAction('[User] Get All Users Success', props<{ data: any }>());
...
export const createUserSuccess = createAction('[User] Create User Success', props<{ message: string, status: number, data: any }>());
...
export const updateUserSuccess = createAction('[User] Update User Success', props<{ message: string, status: number, data: any }>());
...
export const deleteUserSuccess = createAction('[User] Delete User Success', props<{ message: string, status: number, data: any }>());
...
export const signupSuccess = createAction('[User] Signup Success', props<{ message: string, status: number, data: UserStore }>());
